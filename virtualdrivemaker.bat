@Echo Off
@Title Virtual Drive Maker
Setlocal Enabledelayedexpansion
echo. Devnithz Inside.
echo.
echo.
cls
:Init
...
Cls
Echo.
Echo. Virtual Drive maker infomation.
Echo.
Echo. User    = %Username%
Echo. SID     = %SID%
Echo. Path    = %WorkPath%
...
Echo. If any errors please comment on the software page
Echo. located here:https://github.com/Devnithz
Pause
Goto :Main
